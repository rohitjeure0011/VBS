...
import com.vbs.demo.repositiories.HistoryRepo;
import com.vbs.demo.repositiories.TransactionRepo;
import com.vbs.demo.repositiories.UserRepo;
...
public class UserController {
    ...
    public String  update (@RequestBody UpdateDto obj)
    {
        ...
        {
            if(user.getPassword().equals(obj.getValue())) return "Cannot Be Same Password";
            user.setPassword(obj.getValue());
        }
        else if (obj.getKey().equalsIgnoreCase("email"))
        {
            if(user.getEmail().equals(obj.getValue())) return "Cannot Be Same Email";
